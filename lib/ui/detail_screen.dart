...
import 'package:foodaplication/bloc/detail_bloc.dart';
import 'package:foodaplication/model/item_model.dart';
import 'package:foodaplication/resources/favorite_local_provider.dart';
...
class DetailScreen extends StatefulWidget {
  ...
  const DetailScreen(
      {required Key key, required this.idMeal, required this.strMeal, required this.strMealThumb, required this.type})
      : super(key: key);
